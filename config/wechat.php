...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx7e2b9cff9c7f27f7'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'b1143a6bd94ed0205f71ae4ece663e53'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'jassy930'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'S8awQM3tC33K5UoEBymXdnZtVxgfnXedanKXRNCKXFv'),                    // EncodingAESKey
